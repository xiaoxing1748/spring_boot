...
<body>
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<%=basePath%>customer/list.action">阿巴阿巴阿巴</a>
			</div>
			<!-- 导航栏右侧图标部分 -->
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						...
						<li><a href="#" data-toggle="modal"
							data-target="#changePassword"><i class="fa fa-gear fa-fw"></i>
								修改密码</a></li>
						<li class="divider"></li>
						<li><a
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="change_user_password">
						<div class="form-group">
							<label for="new_user_password" class="col-sm-2 control-label">
								密码 </label>
							<div class="col-sm-10">
								<input type="password" class="form-control"
									id="new_user_password" placeholder="密码"
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="changePassword()">确认</button>
				</div>
			</div>
		</div>
	</div>
	...
	$.post("<%=basePath%>user/changepass.action",
	$("#change_user_password").serialize(),
	function(changepass){
		$("#new_user_password").val(changepass.new_user_password);
	        if(changepass =="OK"){
	            alert("修改成功");
